                    ...
                    <ul>
                        <li>
                            ...
                            <div class="company_info">
                                <!-- <strong class="title"><router-link :to="`/5?j_no=${j_no}`" v-model="j_no">회사명</router-link></strong> -->
                                <strong class="title"><router-link :to="`/5?j_no=${j_no}`" @click="getJno">회사명</router-link></strong>
...
export default {
    ...
    methods: {
        ...
        getJno() {
            this.axios.get("/getJobDetail", {params: {j_no: this.j_no}})
