    ...
    <section>
      ...
      <div class="cont_division">
        ...
        <div :style="{ display: ['flex'], flexDirection: ['row'], justifyContent: ['space-between'] }">
          <h3><router-link to="/33">개인 회원가입</router-link></h3>
          <h3 :style="{ borderBottom: ['4px solid #777'] }"><router-link to="/3">기업 회원가입</router-link></h3>
        </div>
        <br><br>
        <div>
