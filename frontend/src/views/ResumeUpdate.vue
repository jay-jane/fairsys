  ...
  <section>
    <div class="resume">
      ...
      <div class="resume-main">
        ...
        <button type="button" value="수정완료" @click="updateForm" style="margin-right: 10px;">수정 완료</button>
        <button type="button" value="취소" @click="cancle" style="margin-right: 10px;">취소</button>
