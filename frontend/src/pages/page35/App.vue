   ...
   <caption>채용공고 현황</caption>
        ...
        <tbody id="table-body">
            <tr>
                ...
                <td>2023-03-06</td>
                <td>진행상황</td>
                <td><input type="submit" value="조회" class="view"></td>
            </tr>
...
.admin_nav {
  ...
  .admin_nav .sub_menu li a {color: black; display: block; width: 155px; padding: 8px 10px 8px 10px; }
